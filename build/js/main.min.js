...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_burger__WEBPACK_IMPORTED_MODULE_2__["initBurger"])();
  Object(_modules_smooth_scroll__WEBPACK_IMPORTED_MODULE_3__["initSmoothScroll"])();
...
var initBurger = function initBurger() {
  ...
  var burgerToggle = header.querySelector('.header__burger-toggle');
  var navList = header.querySelector('.nav__list');
  var logoLink = header.querySelector('.logo');
  if (!burgerToggle) {
    return;
  }
  var onNavListClick = function onNavListClick(evt) {
    if (evt.target.nodeName === 'A') {
      closeMenu();
    }
  };
  var onLogoLinkClick = function onLogoLinkClick() {
    closeMenu();
  };
  var onOverlayClick = function onOverlayClick(evt) {
    var Overlay = evt.composedPath().includes(header);
    if (!Overlay) {
      closeMenu();
    }
  };
